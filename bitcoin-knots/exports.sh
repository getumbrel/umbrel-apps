ISCOREINSTALLED=$($UMBREL_ROOT/scripts/app ls-installed | grep -c -x "bitcoin")
...
if [ "$ISCOREINSTALLED" -eq 1 ]; then
	...
	export APP_BITCOIN_KNOTS_ZMQ_RAWBLOCK_PORT="28332"
	export APP_BITCOIN_KNOTS_ZMQ_RAWTX_PORT="28333"
	export APP_BITCOIN_KNOTS_ZMQ_HASHBLOCK_PORT="28334"
	export APP_BITCOIN_KNOTS_ZMQ_SEQUENCE_PORT="28335"
	export APP_BITCOIN_KNOTS_INTERNAL_RPC_PORT="8332"
	export APP_BITCOIN_KNOTS_INTERNAL_P2P_PORT="8333"
fi
