...
export APP_CORE_LIGHTNING_REST_PORT="2107"
...
export APP_CORE_LIGHTNING_CONFIG_DIR="/data/app"
export APP_CORE_LIGHTNING_MODE="production"
export APP_CORE_LIGHTNING_PATH="/root/.lightning"
export APP_CORE_LIGHTNING_COMMANDO_CONFIG="/root/.lightning/.commando-env"
