<template>
  <div
    class="flex items-center justify-between w-full border-2 border-dashed border-gray-200 dark:border-gray-600 py-2 px-4 font-mono mt-1 bg-white dark:bg-neutral-900 dark:text-white"
  >
    <input
      ref="copy-input-field"
      type="text"
      class="bg-transparent outline-none -mr-2 w-full"
      readonly
      v-model="value"
    />
